...
class BaseBuymeParserAdapterSimpleXmlGetProductsTest extends BaseBuymeParserTest
{
    /**
     * @throws Exception
     */
    ...
    public function testGetProductItemAsProductEntity()
    {
        ...
        foreach ($parser->getProducts() as $item) {
            ...
            $this->assertInstanceOf(Generator::class, $item->offsetGet('params'));

            $this->assertTrue($item->offsetExists('pictures'));
            $this->assertInstanceOf(Generator::class, $item->offsetGet('pictures'));
